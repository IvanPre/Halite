...
Halite: raylib
ifneq (,$(Halite_config))
	@echo "==== Building Halite ($(Halite_config)) ===="
	@${MAKE} --no-print-directory -C build/build_files -f Halite.make config=$(Halite_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f Halite.make clean
